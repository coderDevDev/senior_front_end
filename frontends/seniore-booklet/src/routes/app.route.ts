...
export const router = createBrowserRouter([
  ...
  {
    path: "/senior-app",
    Component: SeniorCitizenLayout,
    children: [
      {
        index: true,
        Component: SeniorCitizenPage, // Change this to show dashboard instead of transaction history
      },
      {
        path: "home",
  ...
  },
  {
    ...
    children: [
      {
        index: true,
        Component: CashierAppPage, // Change this to show dashboard instead of transaction history
      },
      {
        path: "home",
